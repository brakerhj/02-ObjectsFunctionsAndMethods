...
def try_methods_and_functions():
    simple = rg.SimpleTurtle()
    simple.pen = rg.Pen('blue', 5)
    simple.backward(150)
    simple.speed = 1
    draw_many_squares(simple, 2, 100, 30)
    simple.speed = 5
    simple.pen = rg.Pen('red', 5)
    draw_many_squares(simple, 10, 50, 15)
    simple.speed = 100
    simple.pen = rg.Pen("red", 35)
    draw_many_squares(simple, 8, 300, 60)
    simple.pen = rg.Pen("black", 3)
    simple.backward(200)
    simple.draw_circle(30)
    simple.draw_square(50)
    """
    Constructs a SimpleTurtle and sets its   pen  to a new rg.Pen
